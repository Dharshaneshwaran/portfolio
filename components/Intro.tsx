...
const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I am Dharshaneshwaran.</span> I'm a{" "}
        <span className="font-bold">3D artist</span>. I enjoy building{" "}
        <span className="italic">3D environment</span>. My focus is{" "}
        <span className="underline">maya (modeling)</span>.
      </motion.h1>
      <motion.div
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/krishneshwaran-d/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        <a
          ...
          href="https://github.com/Dharshaneshwaran"
          target="_blank"
        >
          <BsGithub />
        </a>
